...
const CardPayment: React.FC = () => {
    ...
    const handleCardNoInputChange = (e: any) => {
        var input = e.target.value
        if (input === "") {
            setcardNo("0123 4567 8910 1112")
        } else {
            setcardNo(input)
        }

        var letters = Array.from(cardNo)
        if (letters.length > 4) {
            var i = 0
            letters.forEach((x: any) => {
                if (i % 5 == 0) {
    ...
    const handleExpDateInputChange = (e: any) => {
        var input = e.target.value
        ...
        if (input === "") {
            ...
            if (input.length > 2 && input.length < 5) {
                var newStr = input.slice(0, 2) + '/' + input.slice(2)
                setexpDate(newStr)
            }
    ...
    const handleSecCodeInputChange = (e: any) => {
        var input = e.target.value
        if (input === "") {
            setsecCode("123")
            ...
            <IonContent placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                <div>
                    <div className="container preload">
                        <div className="creditcard">
                            ...
                            C0,17.9,17.9,0,40,0z" />
                                        ...
                                        <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" className="st2 st3 st4">{cardNo}</text>
                                        ...
                                        <g>
                                            <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" className="st2 st5 st9">{expDate}</text>
                    ...
                    C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                        ...
                                        <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" className="st12 st13">{name}</text>
                                    </g>
                                </svg>
                            </div>
                        </div>
